...
public aspect Cadastro extends ConnectMySQL {
    ...
    ArrayList<Usuario> around(): selecionarTudo() {
     ...
     void around(Usuario usuario)throws Exception,ObjetoJaExistenteExcepitions,ObjetoNaoExistenteExcepitions: 
    	 inserirUsuario(usuario){
    		   		...
    		   		if(resultSet == null){
    		   				...
    		   				statement = connection.prepareStatement
    		   							("INSERT INTO usuario (cpf, nome, foto, email, senha, grad)VALUES(?,?,?,?,?,?)");
    		   				statement.setString(1,usuario.getCPF());
